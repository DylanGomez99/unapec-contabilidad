...
* The original package name 'com.contabilidad.unapec.backend-contabilidad' is invalid and this project uses 'com.contabilidad.unapec.backend_contabilidad' instead.
